...
template <typename T>
void run_workflow_sb2tr_mpi(size_t n, bool validate, int num_gpus, size_t nb,
                            size_t b, bool debug) {
...
template void run_workflow_sb2tr_mpi<float>(size_t n, bool validate,
                                            int num_gpus, size_t nb, size_t b,
                                            bool debug);
template void run_workflow_sb2tr_mpi<double>(size_t n, bool validate,
                                             int num_gpus, size_t nb, size_t b,
                                             bool debug);